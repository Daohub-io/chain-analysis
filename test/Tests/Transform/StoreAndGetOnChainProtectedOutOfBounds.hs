...
module Tests.Transform.StoreAndGetOnChainProtectedOutOfBounds where
...
storeAndGetOnChainProtectedOutOfBounds :: Test
storeAndGetOnChainProtectedOutOfBounds = TestLabel "\"StorerAndGetter\" on chain (protected, out of bounds)" $ TestList
