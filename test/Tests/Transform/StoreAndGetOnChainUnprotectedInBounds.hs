...
module Tests.Transform.StoreAndGetOnChainUnprotectedInBounds where
...
storeAndGetOnChainUnprotectedInBounds :: Test
storeAndGetOnChainUnprotectedInBounds = TestLabel "\"StorerAndGetter\" on chain (unprotected, in bound)" $ TestList
